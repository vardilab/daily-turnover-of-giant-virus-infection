...
def main():
    ...
    metadata.to_pickle(os.path.join(args.data_dir, str(args.metadata_file).replace(".pickle.gz","_dim_reduction.pickle.gz")))
    data_pca.to_pickle(os.path.join(args.data_dir, str(args.data_file).replace(".pickle.gz","_pca.pickle.gz")))
